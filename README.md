...
Of the 24 loss factors in the model, **11 are unsourced estimates (46%)**. Only 8 of those affect the **count** answer; the other 3 are mass-only and cannot move it. That distinction is tracked and reported by the audit rather than glossed over.

Corpus: **58 sources**, 55 facts, 7 products across 5 active species, 31 tables. Every statistic is cited and the build fails if one is not.

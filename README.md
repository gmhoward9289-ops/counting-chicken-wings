...
Of the 28 loss factors in the model, **12 are unsourced estimates (43%)**. Only 9 of those affect the **count** answer; the other 3 are mass-only and cannot move it. That distinction is tracked and reported by the audit rather than glossed over.

Corpus: **117 sources**, 93 facts, 13 products across 8 active species, 36 tables. Every statistic is cited and the build fails if one is not.

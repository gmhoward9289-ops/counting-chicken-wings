...
Of the 22 loss factors in the model, **11 are unsourced estimates (50%)**. Only 8 of those affect the **count** answer; the other 3 are mass-only and cannot move it. That distinction is tracked and reported by the audit rather than glossed over.

Corpus: **54 sources**, 55 facts, 6 products across 4 active species, 31 tables. Every statistic is cited and the build fails if one is not.

...
Of the 26 loss factors in the model, **12 are unsourced estimates (46%)**. Only 9 of those affect the **count** answer; the other 3 are mass-only and cannot move it. That distinction is tracked and reported by the audit rather than glossed over.

Corpus: **113 sources**, 93 facts, 12 products across 7 active species, 36 tables. Every statistic is cited and the build fails if one is not.

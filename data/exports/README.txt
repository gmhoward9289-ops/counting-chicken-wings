...
them is usable on its own.
  ...
  facts               34 rows  chicken facts
  sources             31 rows  citations
  loss_chain          14 rows  loss chain
  mixing_cascade       9 rows  mixing cascade
  ...
  nutrition            2 rows  nutrition per 100g
